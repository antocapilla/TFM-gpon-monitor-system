...
const HistoricalData = ({ isLoading, error, timeSeriesData, startDate, setStartDate, endDate, setEndDate, selectedMetric, setSelectedHistoricalMetric, metricLabels, formatTimestamp }) => {
  return (
    <div className="bg-white rounded-lg shadow-md p-4 mb-4">
      <h2 className="text-3xl font-bold mb-6 text-gray-800">Datos Históricos</h2>

      <div className="mb-4 grid grid-cols-3 gap-4 items-center">
        {/* Metric Selector */}
        <div>
          <label htmlFor="metricSelect" className="block text-lg font-medium text-gray-700">Métrica:</label>
          <select
            id="metricSelect"
        ...
        <div className="col-span-2 flex space-x-2">
          <div>
            <label htmlFor="startDate" className="block text-lg font-medium text-gray-700">Desde:</label>
            <input
              type="date"
              id="startDate"
              className="mt-1 block w-full pl-3 pr-10 py-2 text-base border-gray-300 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm rounded-md"
          ...
          <div>
            <label htmlFor="endDate" className="block text-lg font-medium text-gray-700">Hasta:</label>
            <input
              type="date"
              id="endDate"
              className="mt-1 block w-full pl-3 pr-10 py-2 text-base border-gray-300 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm rounded-md"
